...
#==============================================================================#
                ...
                elif text.lower() == '\ไลค์ออโต้ on':
                	wait['postEndUrl'] = True
                    nadya.sendMessage(msg.to,"เปิดระบบออโต้ไลค์เรียบร้อยแล้ว(。-`ω´-)")
                elif text.lower() == '\ไลค์ออโต้ off'
                    wait['postEndUrl'] = False
                    nadya.sendMessage(msg.to,"ปิดระบบออโต้ไลค์เรียบร้อยแล้ว(。-`ω´-)")
#==============================================================================#
...
#==============================================================================#
                ...
                elif "\ไลค์ออโต้: " in msg.text:
                    wait['comment1'] = msg.text.replace("\ตั้งแทค: ","")
                    nadya.sendMessage(msg.to,"ตั้งค่าตอบกลับคนแทคเสร็จสิ้น(。-`ω´-)")
...
#==============================================================================#
                ...
                elif msg.text in ["\เชคไลค์"]:
                	nadya.sendMessage(msg.to,"เช็คข้อความออโต้ไลค์ล่าสุดคือ(。-`ω´-)" + "\n\n➤" + str(wait["comment1"]))
#==============================================================================#
