                     ...
                     if msg.from_ in admin:
                         ...
                         for s in groups.members:
                             if _name in s.displayName:
                                 nadya.sendMessage(msg.to,"-> " + _name + "อยู่ที่นี้(。-`ω´-)")
                                 break
                         else:
                             for target in targets:
                                 try:
                                     ...
                                     random.choice(KAC).sendMessage(msg.to,"เชิญเรียบร้อยแล้ว(。-`ω´-) :->" + _name)
...
#==============================================================================#
                ...
                if msg.text in ["Me","me","คท","!me","!Me",".me",".Me"]:
                    ...
                    nadya.sendContact(receiver, sender)
...
#==============================================================================#
                ...
                if msg.text in ["Invite","ดึง"]:
                  if msg._from in admin:
                      wait["ricoinvite"] = True
                      random.choice(KAC).sendText(msg.to,"ส่งคท.ด้วย (。-`ω´-)")
...
#==============================================================================#
                if msg.text in ["ตั้งเวลา","หาคนอ่าน"]:
                  nadya.sendText(msg.to, "!โปรดรอ..กรุณาพิมพ์ [อ่าน]")
                  try:
                ...
                read['setTime'][msg.to] = datetime.strftime(now2,"%H:%M")
                read['ROM'][msg.to] = {}
                print read
		  ...
		  if msg.to in read['readPoint']:
	            if read["ROM"][msg.to].items() == []:
	              ...
	              for rom in read["ROM"][msg.to].items():
                    ...
                    nadya.sendText(msg.to, "||===[✍️ᴛ҈ᴇ҈ᴀ҈ᴍ҈🔝T̶̵̷͓͓͓̽̽̽ ҉H̶̵̷͓͓͓̽̽̽ ҉E̶̵̷͓͓͓̽̽̽ ҉F̶̵̷͓͓͓̽̽̽ ҉L̶̵̷͓͓͓̽̽̽ ҉A̶̵̷͓͓͓̽̽̽ ҉S̶̵̷͓͓͓̽̽̽ ҉H̶̵̷͓͓͓̽̽̽ ҉⚡]===||\n\n||==========================||\n\n[รายการอ่านตอนนี้]\n%s\n\n[รายการอ่านทั้งหมด]\n%s\n\n[=======================]\n[เวลาที่ตั้งอ่านครั้งล่าสุด][%s]" % (read['readMember'][msg.to],chiya,setTime[msg.to]))
	          else:
	            nadya.sendText(msg.to, "ไม่สามารถอ่านได้กรุณาตั้งค่าใหม่พิมพ์ [ตั้งเวลา]\nตั้งเสร็จแล้วและจึงลงคำสั่ง [อ่าน](。-`ω´-)")
#==============================================================================#
        if op.type == 55:
